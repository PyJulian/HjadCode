...
if ! grep -qxF 'export PATH="$HOME/.local/bin:$PATH"' "$SHELL_RC"; then
    ...
    echo -e "\033[38;5;46mHjad Installer (Success): ~/.local/bin is already in your PATH.\033[0m"
fi
echo -e "\033[38;5;214mHjad Installer (Info): Reloading your shell configuration...\033[0m"
source "$SHELL_RC"
echo -e "\033[38;5;34mHjad Installer (Success): Hjad successfully installed!\033[0m"
